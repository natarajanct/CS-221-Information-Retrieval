...
from datamodel.search.UganlaAdithyasNchidham_datamodel import UganlaAdithyasNchidhamProjectionLink
...
@Deleter(UganlaAdithyasNchidhamProjectionLink)
@Getter(UganlaAdithyasNchidhamProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(UganlaAdithyasNchidhamProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(UganlaAdithyasNchidhamProjectionLink, l)
